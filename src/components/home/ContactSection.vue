...
function onSubmit() {
  const fb = clinic.facebookUrl || clinic.social.facebook
    ...
    <div class="container">
      <div class="contact__head">
        <div>
          ...
          <h2 ref="title" class="contact__title display">
            Find us on <em>MacArthur Rd</em>
          </h2>
        </div>
        <p data-anim class="lead contact__lead">
          Cash only. Call ahead or check Facebook for today's lunch hours.
        </p>
      </div>
      ...
      <div class="contact__grid">
        <div class="contact__info">
          ...
          <div data-anim class="info">
            <p class="mono info__label">Phone & updates</p>
            <p class="info__value">
              <a :href="`tel:${clinic.phone.replace(/\D/g, '')}`">{{ clinic.phone }}</a><br />
              <a :href="clinic.facebookUrl || clinic.social.facebook" target="_blank" rel="noopener noreferrer">{{ clinic.email }}</a>
            </p>
          </div>
        ...
        <form data-anim class="form" @submit.prevent="onSubmit">
          ...
          <label class="field">
            ...
            <input v-model="form.phone" type="tel" autocomplete="tel" required placeholder="(optional)" />
          </label>
          ...
          <label class="field">
            ...
            <textarea v-model="form.message" rows="3" placeholder="Hours, large orders, or just saying hi" />
          </label>
