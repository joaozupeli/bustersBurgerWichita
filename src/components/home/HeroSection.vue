...
const facts = [
  ...
  { label: 'Crowd', value: `${clinic.stats[0].value}${clinic.stats[0].suffix} on Facebook` },
]
      ...
      <div ref="aside" class="hero__grid">
        <div class="hero__intro">
          ...
          <div data-intro class="hero__actions">
            <a class="btn btn--solid" :href="clinic.facebookUrl || clinic.social.facebook" target="_blank" rel="noopener noreferrer">
    ...
    <div class="hero__mediaWrap">
      <div ref="frame" class="hero__frame">
        <img
          ref="photo"
          class="hero__photo"
          src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=2000&h=1125&fit=crop&auto=format"
